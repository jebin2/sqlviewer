              ...
              {visibleColIndices.map(({ name: col, idx }) => {
                 ...
                 return (
                    <th 
                        ...
                        onClick={() => onSort(col)}
                        className={`
                            px-6 py-4 font-semibold border-b border-slate-200 min-w-[180px] whitespace-nowrap cursor-pointer transition-colors group select-none
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span>{col}</span>
                        {colInfo && (
                            <span className={`text-xs font-normal px-1.5 py-0.5 rounded border ${isSorted ? 'bg-blue-100 text-blue-600 border-blue-200' : 'text-slate-400 bg-slate-200/50 border-transparent'}`}>
                                {colInfo.type}
                            </span>
                        )}
